...
abstract class $ConversationModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String conversationId, UserModel user, String lastMessage});
...
class _$ConversationModelImpl implements _ConversationModel {
  ...
  @override
  String toString() {
    return 'ConversationModel(conversationId: $conversationId, user: $user, lastMessage: $lastMessage)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, conversationId, user, lastMessage);
...
abstract class _ConversationModel implements ConversationModel {
  const factory _ConversationModel(
      ...
      required final String lastMessage}) = _$ConversationModelImpl;
