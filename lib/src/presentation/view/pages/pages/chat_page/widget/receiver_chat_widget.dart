...
class ReceiverChatWidget extends StatelessWidget {
  ...
  const ReceiverChatWidget({super.key, required this.message, required this.meIsSender});
  @override
  Widget build(BuildContext context) {
    return Align(
      alignment:meIsSender ? Alignment.centerRight : Alignment.centerLeft,
      child: Padding(
        padding: EdgeInsets.only(top: 6, bottom: 6, left: meIsSender ? .25.space(context) : 0, right: !meIsSender ? .1.space(context) : 0),
        child: DecoratedBox(
