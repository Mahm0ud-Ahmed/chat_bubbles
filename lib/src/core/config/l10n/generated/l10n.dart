...
class S {
  ...
  /// `Sorry, the search results do not match the name of the movie you are looking for.`
  ...
  /// `Permission denied`
  String get alert_dialog_permission_denied_title {
    return Intl.message(
      'Permission denied',
      name: 'alert_dialog_permission_denied_title',
      desc: '',
      args: [],
    );
  }
  ...
  String get alert_dialog_permission_denied_msg {
    return Intl.message(
      'Permission to the application has been denied. Unfortunately, you will not be able to complete your task until the permission is granted. Please go to the device settings and grant permission to the application.',
      name: 'alert_dialog_permission_denied_msg',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Go to settings`
  String get button_go_device_setting_title {
    return Intl.message(
      'Go to settings',
      name: 'button_go_device_setting_title',
      desc: '',
      args: [],
    );
  }
